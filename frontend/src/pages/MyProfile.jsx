...
export default function Profile() {
  ...
  const handleAddProject = () => {
    ...
    const isCompleted = window.confirm("Is this project complete? (Click Cancel for Active)");
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-5 py-2 border border-indigo-200 text-indigo-600 rounded-lg font-semibold bg-white hover:bg-indigo-50 transition text-sm cursor-pointer"
          >
            Edit Profile
          </button>
          <button
            onClick={handleSaveChanges}
            className="px-5 py-2 bg-[#4338CA] text-white rounded-lg font-semibold shadow-sm hover:bg-indigo-800 transition text-sm cursor-pointer"
          >
            Save Changes
          </button>
        </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row gap-6 items-start">
            <div className="relative group flex-shrink-0 mx-auto md:mx-0">
              ...
              <button
                ...
                className="absolute bottom-1 right-1 bg-indigo-600 text-white p-1.5 rounded-lg shadow hover:bg-indigo-700 transition cursor-pointer"
              >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 border border-dashed border-slate-300 hover:border-indigo-500 rounded-full text-xs text-slate-500 flex items-center gap-1 transition cursor-pointer"
                >
                  + Add Skill
                </button>
              </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="Project Manager / Team Leader">Project Manager / Team Leader</option>
                <option value="Business Analyst">Business Analyst</option>
                <option value="System Analyst">System Analyst</option>
                <option value="API Integration Developer">API Integration Developer</option>
                <option value="Cloud Engineer">Cloud Engineer</option>
                <option value="Data Scientist">Data Scientist</option>
                <option value="Game Developer">Game Developer</option>
                <option value="Embedded Systems Developer">Embedded Systems Developer</option>
                <option value="Documentation / Technical Writer">Documentation / Technical Writer</option>
            ...
            <div>
              ...
              <div className="bg-indigo-50/60 border border-indigo-100 rounded-xl p-3 space-y-2">
                <div className="flex items-center gap-2 text-indigo-700">
                  ...
                  <span className="text-xs font-bold text-slate-700">{collaboration.weeklyHours} Hours / Week</span>
                </div>
                <input
                  type="range"
                  min="5"
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key={project.id} className="border border-slate-200 rounded-xl p-4 flex flex-col justify-between hover:shadow-md transition bg-white">
              <div>
                <div className="flex justify-between items-start">
                  ...
                  <span
                    className={`px-2 py-0.5 font-bold text-[10px] uppercase tracking-wider rounded ${
          ...
          <button
            ...
            className="border-2 border-dashed border-slate-200 hover:border-indigo-400 rounded-xl p-6 flex flex-col items-center justify-center text-slate-400 hover:text-indigo-600 transition min-h-[160px] cursor-pointer group"
          >
            <span className="w-10 h-10 rounded-full bg-slate-50 group-hover:bg-indigo-50 flex items-center justify-center mb-2 font-bold text-lg">
              +
            </span>
